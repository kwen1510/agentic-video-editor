...
export async function GET(request: Request) {
  ...
  const project: TimelineProject = {
    ...
    music: [
      {
        id: 'music_moonpurr_paper_airplane_parade',
        src: '/music/imports/moonpurr-paper-airplane-parade.mp3',
        name: 'Paper Airplane Parade',
        artist: 'MoonPurr',
        sourceUrl: 'https://www.moonpurr.com/',
        licenseType: 'CC BY 4.0',
        licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
        licenseStatus: 'confirmed',
        attributionRequired: true,
        attribution: 'Music: "Paper Airplane Parade" by MoonPurr, licensed under Creative Commons Attribution 4.0. Source: https://www.moonpurr.com/',
        start: 0,
        end: 30,
        volume: 0.2,
        fadeIn: 1.25,
        ...
        volumeAutomation: {
          ...
          points: [
            {id: 'vol_01', time: 0, volume: 0.9},
            {id: 'vol_02', time: 2.65, volume: 0.9},
            {id: 'vol_03', time: 3, volume: 0.2},
            {id: 'vol_04', time: 30, volume: 0.2},
          ],
        },
      },
    ],
