...
export const musicBriefGuides: MusicBriefGuide[] = [
  {
    ...
    preferredSources: ['dig-ccmixter', 'moonpurr', 'free-music-archive'],
    vocal: 'instrumental',
    energy: 'high',
    bpmRange: '90-120',
    defaultVolume: 0.22,
    ...
    sampleTrackId: 'carefree-kevin-macleod',
  },
  {
    id: 'lofi-study',
    ...
    preferredSources: ['free-music-archive', 'openverse-audio', 'moonpurr'],
    vocal: 'instrumental',
    energy: 'medium',
    bpmRange: '70-90',
    defaultVolume: 0.18,
    ...
    sampleTrackId: 'clear-air-kevin-macleod',
  },
  {
    id: 'gen-z-pop',
    ...
    preferredSources: ['dig-ccmixter', 'bensound', 'free-music-archive'],
    vocal: 'either',
    energy: 'high',
    bpmRange: '100-130',
    defaultVolume: 0.2,
    ...
    sampleTrackId: 'werq-kevin-macleod',
  },
  {
    id: 'documentary-warm',
    ...
    preferredSources: ['incompetech', 'anvil-island', 'openverse-audio'],
    vocal: 'instrumental',
    energy: 'low',
    bpmRange: '60-85',
    defaultVolume: 0.16,
    ...
    sampleTrackId: 'reunited-kevin-macleod',
  },
  {
    id: 'cinematic-opener',
    ...
    preferredSources: ['incompetech', 'bensound', 'free-music-archive'],
    vocal: 'instrumental',
    energy: 'medium',
    bpmRange: '70-110',
    defaultVolume: 0.24,
    ...
    sampleTrackId: 'hot-pursuit-kevin-macleod',
  },
  {
    id: 'retro-playful',
    title: 'Retro Playful',
    ...
    preferredSources: ['openverse-audio', 'free-music-archive', 'dig-ccmixter'],
    vocal: 'instrumental',
    energy: 'medium',
    bpmRange: '85-120',
    defaultVolume: 0.2,
    ...
    sampleTrackId: 'hep-cats-kevin-macleod',
  },
];
